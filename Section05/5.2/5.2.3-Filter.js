...
let todos6 = data.filter((user6)) = user6.
let user6tasks = data.filter(item => item.useriD === 6);

letuser6CompletedTasks = user6tasks.filter(task => task.completed == true);
console.log(user6CompletedTasks);
// filter for tasks with a title less than 24 characters long
let shortTitle = data.filter((thisCanBeNamedWhateverYouWantItToBeNamed) => thisCanBeNamedWhateverYouWantItToBeNamed.title < 24);
